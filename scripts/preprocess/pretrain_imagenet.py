...
if __name__ == '__main__':
    ...
    # PIE dataset path
    parser.add_argument('--train_path', type=str, default="/data/datasets/imagenet/train")
    parser.add_argument('--val_path', type=str, default="/data/datasets/imagenet/val")
    parser.add_argument('--resume', type=str, default="", help='path to resume weights')
