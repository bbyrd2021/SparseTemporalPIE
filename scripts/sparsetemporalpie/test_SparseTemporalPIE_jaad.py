"""
test_SparseTemporalPIE_jaad.py
===============================
Evaluates SparseTemporalPIE v4 weights on the JAAD test set.
...
def main(args):
    ...
    test_seq      = jaad.generate_data_trajectory_sequence('test', **data_opts)
    seq_len       = data_opts['max_size_observe']
    test_seq_data = jaad.get_train_val_data(test_seq, data_type, seq_len, data_opts['seq_overlap_rate'])
    ...
    print("\n" + "="*55)
    print("  SparseTemporalPIE v4 -- JAAD Evaluation Results")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights',       default='weights_sparse_v4/best_sparse_step2.pth')
