"""
pie_sparse_incremental_learning_v3.py
======================================
Incremental learning for SparseTemporalPIE v3.
...
def main(args):
    ...
    for step in il_steps:
        ...
        best_val_acc  = 0.0
        best_path     = os.path.join(args.output_dir, f'best_sparse_v3_step{step}.pth')
        min_loss      = 100.0
        min_loss_path = os.path.join(args.output_dir, f'min_loss_sparse_v3_step{step}.pth')
        ...
        for epoch in range(args.epochs):
            ...
            if epoch >= 5:
                torch.save(curr_model.state_dict(),
                           os.path.join(args.output_dir, f'model_{epoch}_sparse_v3_step{step}.pth'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights',          default='weights_sparse_v3_imagenet/best_sparse_v3_step0.pth')
