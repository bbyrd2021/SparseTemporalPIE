"""
train_SparseTemporalPIE_v3.py
=============================
Base training for SparseTemporalPIE v3: IL step=0, 70 epochs.

Multi-frame cross-attention + 68-d pose (static + velocity) + bbox_traj + ctx_feats.
Supports both ImageNet and EfficientPIE pretrained backbone initialization.
"""
...
def main(args):
    ...
    best_val_acc  = 0.0
    best_path     = os.path.join(args.output_dir, f'best_sparse_v3_step{args.step}.pth')
    min_loss      = 100.0
    min_loss_path = os.path.join(args.output_dir, f'min_loss_sparse_v3_step{args.step}.pth')

    print("Start Training (v3)!")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-dir',     default='weights_sparse_v3_imagenet')
