...
python scripts/efficientpie/train_EfficientPIE_JAAD.py \
    --data-path "$DATA_PATH" \
...
for STEP in "${STEPS[@]}"; do
    ...
    python scripts/efficientpie/jaad_domain_incremental_learning.py \
        --data-path "$DATA_PATH" \
...
python scripts/efficientpie/test_EfficientPIE_JAAD.py \
    --data-path "$DATA_PATH" \
